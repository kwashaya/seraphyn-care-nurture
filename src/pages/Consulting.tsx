    ...
    <section className="seraphyn-section">
      <div className="seraphyn-container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <img src={consultingImage.url} alt="Senior healthcare consultant presenting workforce analytics to hospital executives in a modern boardroom" className="w-full h-full object-cover" />
          </motion.div>
        </div>
      </div>
    </section>
