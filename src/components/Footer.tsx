      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <div className="flex gap-4 mt-4">
            ...
            <a href="https://www.instagram.com/seraphyncare" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-accent transition-colors"><Instagram size={20} /></a>
            ...
            <a href="https://www.linkedin.com/company/seraphyn-care-solutions" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-accent transition-colors"><Linkedin size={20} /></a>
          </div>
        </div>
      </div>
